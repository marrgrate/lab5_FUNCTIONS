//¬ычислить корень уравнени€ f (x) = 0 на отрезке [a; b] с точностью eps = 10Ц6
//использу€ заданный метод (ћ = 1 Ц метод половинного делени€, ћ = 2 Ц метод
//касательных, ћ = 3 Ц метод хорд) дл€ заданных функций. 
//¬ычисление корн€ уравнени€ оформить в виде функции с функциональным параметром, 
//параметры a, b, eps, s Ц в виде аргументов по умолчанию. 
